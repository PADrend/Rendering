# Try to find OpenGL and GLEW, or OpenGL ES 2.x. Once done, this will define:
#
...
if(OPENGL_FOUND AND GLEW_FOUND)
	...
	set(GLIMPLEMENTATION_INCLUDE_DIR ${OPENGL_INCLUDE_DIR} ${GLEW_INCLUDE_DIRS})
	set(GLIMPLEMENTATION_LIBRARY ${OPENGL_LIBRARIES} ${GLEW_LIBRARIES})
elseif(GLESV2_FOUND)
	...
	message(FATAL_ERROR "Neither OpenGL and GLEW nor OpenGL ES 2.x were found.")
endif()
