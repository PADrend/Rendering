...
[[deprecated]]
RENDERINGAPI Util::AttributeFormat glPixelFormatToPixelFormat(const PixelFormatGL& glPixelFormat);
[[deprecated]]
static uint32_t textureTypeToGLTextureType(TextureType type) { return 0; }

RENDERINGAPI Texture::Ref createStdCubeTexture(const Device::Ref& device, uint32_t width, bool alpha);
[[deprecated]]
...
RENDERINGAPI Texture::Ref createHDRCubeTexture(const Device::Ref& device, uint32_t width, bool alpha);
[[deprecated]]
...
RENDERINGAPI Texture::Ref createStdTexture(const Device::Ref& device, uint32_t width, uint32_t height, bool alpha);
[[deprecated]]
...
RENDERINGAPI Texture::Ref createNoiseTexture(const Device::Ref& device, uint32_t width, uint32_t height, bool alpha, float scaling = 1.0f);
[[deprecated]]
...
RENDERINGAPI Texture::Ref createHDRTexture(const Device::Ref& device, uint32_t width, uint32_t height, bool alpha);
[[deprecated]]
...
RENDERINGAPI Texture::Ref createRedTexture(const Device::Ref& device, uint32_t width, uint32_t height, bool useByte = false);
[[deprecated]]
...
RENDERINGAPI Texture::Ref createDepthStencilTexture(const Device::Ref& device, uint32_t width, uint32_t height);
[[deprecated]]
...
RENDERINGAPI Texture::Ref createDepthTexture(const Device::Ref& device, uint32_t width, uint32_t height, uint32_t layers=1);
[[deprecated]]
...
RENDERINGAPI Texture::Ref createHDRDepthTexture(const Device::Ref& device, uint32_t width, uint32_t height, uint32_t layers=1);
[[deprecated]]
...
RENDERINGAPI Texture::Ref createMultisampleDepthTexture(const Device::Ref& device, uint32_t width, uint32_t height, uint32_t samples=4);
[[deprecated]]
...
RENDERINGAPI Texture::Ref createMultisampleTexture(const Device::Ref& device, uint32_t width, uint32_t height, bool alpha, uint32_t samples=4);
[[deprecated]]
...
*/
RENDERINGAPI Texture::Ref createColorTexture(const Device::Ref& device, TextureType type,uint32_t sizeX,uint32_t sizeY, uint32_t numLayers, Util::TypeConstant dataType, uint8_t numComponents,bool filtering,bool clampToEdge=false,uint32_t samples=4);
[[deprecated]]
...
/*! @p numComponents == 1 || 2 || 3|| 4
	...
	@note If the texture should be used as image(load and store), only 1,2,or 4 components are valid.
*/
RENDERINGAPI Texture::Ref createDataTexture(const Device::Ref& device, TextureType type,uint32_t sizeX,uint32_t sizeY, uint32_t numLayers, Util::TypeConstant dataType, uint8_t numComponents);
[[deprecated]]
...
RENDERINGAPI Texture::Ref createTextureDataArray_Vec4(const Device::Ref& device, const uint32_t size);
[[deprecated]]
...
RENDERINGAPI Texture::Ref createChessTexture(const Device::Ref& device, uint32_t width, uint32_t height, int fieldSize_powOfTwo=8, bool filtering=true, bool clampToEdge=false);
[[deprecated]]
...
RENDERINGAPI Texture::Ref createColorPalette(const Device::Ref& device, const std::vector<Util::Color4f>& colors);
[[deprecated]]
...
RENDERINGAPI Texture::Ref createTextureFromBitmap(const Device::Ref& device, const Util::Bitmap & bitmap, TextureType type = TextureType::TEXTURE_2D, uint32_t numLayers=1, bool clampToEdge = false);
[[deprecated]]
...
RENDERINGAPI Texture::Ref createTextureFromScreen(const Device::Ref& device, int xpos, int ypos, const Texture::Format & format);
[[deprecated]]
...
RENDERINGAPI Texture::Ref createTextureFromScreen(const Device::Ref& device, int xpos=0, int ypos=0, int width=-1, int height=-1,bool useAlpha = true);
[[deprecated]]
...
RENDERINGAPI void updateTextureFromScreen(const Device::Ref& device, Texture& t, const Geometry::Rect_i& textureRect, int screenPosX=0, int screenPosY=0);
RENDERINGAPI void updateTextureFromScreen(const Device::Ref& device, Texture& t);
...
RENDERINGAPI void drawTextureToScreen(RenderingContext& rc, const Geometry::Rect_i & screenRect, const std::vector<Texture *>& textures, const std::vector<Geometry::Rect_f>& textureRects);
...
RENDERINGAPI Util::Reference<Util::Bitmap> createBitmapFromTexture(Texture& texture);
[[deprecated]]
...
RENDERINGAPI Util::Reference<Util::PixelAccessor> createColorPixelAccessor(Texture& texture);
[[deprecated]]
...
RENDERINGAPI Util::Reference<Util::PixelAccessor> createDepthPixelAccessor(Texture& texture);
[[deprecated]]
...
RENDERINGAPI Util::Reference<Util::PixelAccessor> createStencilPixelAccessor(Texture& texture);
[[deprecated]]
